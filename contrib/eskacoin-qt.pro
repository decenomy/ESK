...
RESOURCES += src/qt/eskacoin.qrc src/qt/eskacoin_locale.qrc

TRANSLATIONS += src/qt/locale/eskacoin_bg.ts \
                src/qt/locale/eskacoin_de.ts \
                src/qt/locale/eskacoin_en.ts \
                src/qt/locale/eskacoin_es.ts \
                src/qt/locale/eskacoin_fi.ts \
                src/qt/locale/eskacoin_fr.ts \
                src/qt/locale/eskacoin_it.ts \
                src/qt/locale/eskacoin_ja.ts \
                src/qt/locale/eskacoin_pl.ts \
                src/qt/locale/eskacoin_pt.ts \
                src/qt/locale/eskacoin_ru.ts \
                src/qt/locale/eskacoin_sk.ts \
                src/qt/locale/eskacoin_sv.ts \
                src/qt/locale/eskacoin_vi.ts \
                src/qt/locale/eskacoin_zh_CN.ts \
                src/qt/locale/eskacoin_zh_TW.ts
