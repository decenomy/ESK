...
#ifndef ESKACOIN_ZESKTRACKER_H
#define ESKACOIN_ZESKTRACKER_H
...
public:
    CzESKTracker(std::string strWalletFile);
    ~CzESKTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzESKWallet* zESKWallet = NULL);
