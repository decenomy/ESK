...
#ifndef ESKACOIN_ZESKWALLET_H
#define ESKACOIN_ZESKWALLET_H
...
public:
    CzESKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZESK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZESK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
