                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzESKPathCustom = GetArg("-zeskbackuppath", "");
    ...
    if(!strzESKPathCustom.empty()) {
        ui->wallet_customzeskbackuppath->setText(QString::fromStdString(strzESKPathCustom));
        ui->wallet_customzeskbackuppath_label->setVisible(true);
        ui->wallet_customzeskbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzESKPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ESKACOIN RPC console.") + "<br>" +
