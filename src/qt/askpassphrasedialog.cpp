...
// Copyright (c) 2015-2018 The ESKACOIN developers
                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zESK || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    // It doesn't make sense to show the checkbox for sending ESK because you wouldn't check it anyway.
    if (context == Context::Send_ESK || context == Context::Send_zESK) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR ESK</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
