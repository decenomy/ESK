 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZESK));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
//    typeWidget->addItem(tr("Received ESK from zESK"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
...
//    typeWidget->addItem(tr("Zerocoin Spend, Change in zESK"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEsk));
