...
public:
    ...
    void setZEskControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzESK_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzESK_clicked();
    void on_pushButtonZEskControl_clicked();
