...
public:
    ...
    int EskaCoinBadBlockTime() const { return nEskaCoinBadBlockTime; }
    int EskaCoinBadBlocknBits() const { return nEskaCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nEskaCoinBadBlockTime;
    unsigned int nEskaCoinBadBlocknBits;
