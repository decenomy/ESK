...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "eskacoin" is a composite category enabling all ESKACOIN-related debug output
            if (ptrCategory->count(std::string("eskacoin"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "eskacoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "eskacoind.pid"));
