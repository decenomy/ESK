...
/**
 * ESKACOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzeskseed(const UniValue& params, bool fHelp);
extern UniValue getzeskseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzesk(const UniValue& params, bool fHelp);
extern UniValue dzeskstate(const UniValue& params, bool fHelp);
