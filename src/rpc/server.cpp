...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ESKACOIN features */
        {"eskacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"eskacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"eskacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"eskacoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"eskacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"eskacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"eskacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"eskacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"eskacoin", "startmasternode", &startmasternode, true, true, false},
        {"eskacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"eskacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"eskacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"eskacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"eskacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"eskacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"eskacoin", "preparebudget", &preparebudget, true, true, false},
        {"eskacoin", "submitbudget", &submitbudget, true, true, false},
        {"eskacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"eskacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"eskacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"eskacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"eskacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"eskacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"eskacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eskacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"eskacoin", "mnsync", &mnsync, true, true, false},
        {"eskacoin", "spork", &spork, true, true, false},
        {"eskacoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
//        {"zerocoin", "getzeskseed", &getzeskseed, false, false, true},
//        {"zerocoin", "setzeskseed", &setzeskseed, false, false, true},
//        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
//        {"zerocoin", "searchdzesk", &searchdzesk, false, false, true},
//        {"zerocoin", "dzeskstate", &dzeskstate, false, false, true},
