...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the eskacoin unit tests or QA tests
...
[Translation Process](https://github.com/Eskacoin/Eskacoin-Project/blob/master/doc/translation_process.md)
