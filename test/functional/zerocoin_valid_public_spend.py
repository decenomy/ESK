...
from fake_stake.base_test import ESKACOIN_FakeStakeTest

class zESKValidCoinSpendTest(ESKACOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zESKs..." % DENOM_TO_USE)
